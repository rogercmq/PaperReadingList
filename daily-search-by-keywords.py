...
def send_email(receiver, title, content):
    ...
    sender = 'rogercmq@163.com'
    # sender's email username and password
    user = 'rogercmq@163.com'
    ...
    password = 'KBQHTUWGARVFGGIK'  
    # smtp server address
    smtpserver = 'smtp.163.com'  # e.g., smtp.163.com for 163.com
...
def main(URL="", keywords=[], notinterestedkeywords=[], localdir=""):
    ...
    not_interested_subjects = [] # domains to be removed
    ...
    # email receiver
    receiver = 'rogercmq@163.com' # we recommand to send emails to ourselves, otherwise the emails may be classifies as spam emails
    has_statistics = False  # whether email containing statistics of sub-domains (such as cs.CV) in cs
    download_pdf = False  # whether downloading pdfs
    ...
    if download_pdf:
        ...
        for selected_paper_id, selected_paper_title in zip(selected_papers['id'], selected_papers['title']):
            ...
            try:
                ...
                print(f"Fail to download {selected_paper_title}")
